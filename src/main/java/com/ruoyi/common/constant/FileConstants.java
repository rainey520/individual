...
public class FileConstants {
    ...
    /**
     * 文件保存类型
     * 0、公司轮播图信息，1、订单 2、采购单 3、产品对账单文件 4、物料对账单文件 5、产品 6、物料
     * 7、产品出库 8、客户退货 9、物料入库 10、物料退货 11、生产发料 12、生产入库
     *  13、库存内部调整、14 报表相关，15、产品MES相关文件
     */
    public static final int FILE_SAVETYPE_COM_PIC = 0;
    public static final int FILE_SAVETYPE_PRO_MES = 15;
